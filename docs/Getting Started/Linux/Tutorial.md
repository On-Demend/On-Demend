...
> 유닉스는 상용 소프트웨어로 시작되었지만, 이후 리눅스 등 오픈소스 운영체제의 기반이 되었습니다.

---

## 🐧 리눅스(Linux)

**리눅스**는 유닉스를 기반으로 1991년 **리누스 토르발스(Linus Torvalds)**가 개발한  
**오픈소스 운영체제 커널**입니다.
...
- **🔓 오픈소스**  
  누구나 소스코드를 자유롭게 열람, 수정, 배포할 수 있습니다.

- **💪 안정성과 보안성**  
  장시간 무중단 서버 운영에 적합하며, 권한 기반 구조로 보안성이 높습니다.

- **🧩 다양한 배포판**  
  사용자 목적에 맞게 수많은 배포판이 존재합니다.

- **⚙️ 다양한 환경에서의 호환성**  
  클라우드, 모바일(Android), 슈퍼컴퓨터, 라즈베리파이 등에서 폭넓게 사용됩니다.

---

# 🧭 리눅스 배포판(Distro) 계열 정리

리눅스 배포판은 커널은 동일하지만, **패키지 관리 방식, 철학, 설정 도구** 등에 따라  
여러 계열로 나뉩니다. 대표적으로 다음의 3대 계열이 있습니다.
...
> 📌 리눅스는 단순한 운영체제를 넘어 현대 IT 인프라의 핵심입니다.  
> 서버, 클라우드, 개발 환경, IoT까지 — 모든 곳에서 리눅스가 사용되고 있습니다.
